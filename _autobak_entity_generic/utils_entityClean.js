...
const DATE_WORDS = ['今天', '明天', '昨天', '今日', '明日', '昨日', '后日', '后天', '前天', '今年', '去年', '明年', '前年', '当年', '当时', '现在', '目前', '今晚', '明晚', '昨晚', '本月', '上月', '下月', '本周', '上周', '下周', '周末', '年初', '年底', '月初', '月末', '每天', '每日', '天天', '整天', '当天', '当日', '次日', '翌日', '日后', '平日', '平时', '白天', '深夜', '半夜', '傍晚', '午后', '清早', '早晨', '凌晨', '每年', '每次']
...
const CONNECT_WORDS = ['因此', '但是', '可是', '因为', '所以', '虽然', '然而', '不过', '然后', '于是', '而且', '并且', '或者', '如果', '既然', '尽管', '即使', '无论', '只要', '只有', '我们', '你们', '他们', '她们', '它们', '咱们', '自己', '另外', '俺', '咱']
